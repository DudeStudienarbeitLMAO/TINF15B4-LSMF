...
public class HelpListAdapter extends BaseExpandableListAdapter {
    ...
    public HelpListAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.help_list_view_row, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.help_list_view_group, null);
        }
